...
import { Button_EM, Input_EM, SearchBtn_EM, TableInput_EM, Selectbox_EM } from "Elements";

const UserMngModalWrapper = styled.div`
  .box {
    width: 900px;
        ...
        <div className="box">
          ...
          <div className="form">
            <div className="layer">
              ...
              <SearchBtn_EM onClick={getList} />
            </div>
            <div className="layer">
              <Button_EM btnText="저장" onClick={onClickSave} />
              <Button_EM btnText="삭제" onClick={onClickDelete} />
              <Button_EM btnText="행추가" className="rightBtn" onClick={onClickAddRow} />
              <Button_EM btnText="행삭제" className="rightBtnEnd" onClick={onClickRemoveRow} />
            </div>
                  ...
                  {list.length > 0 &&
                    list.map((v, i) => (
                      <tr key={i}>
                        ...
                        <td className="tableData">
                          <TableInput_EM onChange={(e) => onChangeUser(e, i)} value={list[i]?.userNm || ""} />
                        </td>
                        <td className="tableData">
                          <TableInput_EM 
                        ...
                        <td className="tableData">
                          <Selectbox_EM option={adminItem} onChange={(e) => onChangeAdminFlag(e, i)} defaultValue={list[i]?.adminFlag === null ? '' : list[i]?.adminFlag} />
                        </td>
                        <td className="tableData">
                          <TableInput_EM
