...
const FacilityIPRegModalWrapper = styled.div`
  .box {
    width: 65%;
  ...
  .cellWrap {
    padding: 20px;
    border: 2px solid ${palette2.PrimaryColor};
    border-radius: 10px;
    max-height: 300px;
    overflow: auto;
...
const FacilityIPRegModal = ({
  ...
  return (
    <FacilityIPRegModalWrapper>
      <div className="modalBg">
        <div className="box">
          <div className="titleSection">
            <div className="modalTitle">{checkedMaster ? "설비그룹 수정" : "설비그룹 등록"}</div>
          </div>
          <div className="form">
            <div className="layer">
...
export default FacilityIPRegModal;
